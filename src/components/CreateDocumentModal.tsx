...
const CreateDocumentModal: React.FC<CreateDocumentModalProps> =({open, handleCreateDocument, onClose}) => {
            ...
            <div className="">  
              ...
              <form onSubmit={handleSubmit} id="create-form">
                  ...
                  <DialogActions>
                    ...
                    <Button type="submit" form="create-form" disabled={isCreating || !title.trim()}>
